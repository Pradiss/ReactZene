            ...
            <Header />
                ...
                <div className="container my-5">
                    <div className="row">
                        ...
                        <p><span >A sua privacidade é importante para nós. É política do Zene respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="https://zene.com.br">Zene</a>, e outros sites que possuímos e operamos.</span></p>
                        ...
                        <p><span >O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Zene oferece no site e com caráter enunciativo, mas não limitativo:</span></p>
                        <ul>
                            <li><span >A Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</span></li>
                            <li><span >B Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, </span><span ><a href='' >166bet</a></span><span > ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</span></li>
                            <li><span >C Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Zene, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</span></li>
                        </ul>
                        ...
                        <p><span >Esta política é efetiva a partir de&nbsp;11 March 2025 02:33</span></p>
